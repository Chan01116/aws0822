...
<body>
	...
	//1. 코어객체
	//1-1 배열객체
	//[]표현할수 있고 Array객체로 할 수도 있다.
	
	//배역객체 생성
	let arrName = ["나","은지","이슬","인서"];
	...
	arrName[7] = "형구";
	document.write("6번째 사람의 이름은?"+arrName[5]+"<br>");
	let intRoom = arrName.length;
	document.write("생성된 총 방의 갯수는"+intRoom+"<br>");
	...
	//나중에 배열값을 담을 수도 있다.
	let week = new Array(7);     // 방 갯수부터 만든다
	week[0] = "월";
	week[1] = "화";
	week[2] = "수";
	week[3] = "목";
	...
	// 문제
	// 수학점수가 90점 영어점수가 80점 국어점수가 75번인 사람의 총합과 평균값을
	// 배열을 통해서 구현하시오
	...
	let sum = 0;
	let evr = 0;
	for(let i = 0; i< calss.length; i++){
		sum = sum + calss[i];
		evr = sum/calss.length;
		
		
	}
	
	
	document.write("모든점수의 총합은? : "+sum+"<br>");
	document.write("모든점수의 평균값은? : "+evr+"<br>");
	...
	/* let a = new Array(90,80,75); */ // 세번째
	
	/* let a = new Array();  // 네번째 크기가 추가할때 마다 자동증가
	a[0] = 90;
	a[1] = 80;
	a[2] = 75; */
